import {
  ...
  useStoryRenderer
} from "./chunk-555UG57G.js";
import "./chunk-2LMJ6ASW.js";
import {
  check_target,
  component,
  ...
  legacy_api,
  prop
} from "./chunk-I6NXBAOA.js";
import {
  append,
  comment,
  mount,
  unmount
} from "./chunk-5LY677AK.js";
import {
  FILENAME,
  HMR,
  add_svelte_meta,
...
function StoriesExtractor($$anchor, $$props) {
  ...
  const Stories = prop($$props, "Stories", 7), repository = prop($$props, "repository", 7);
  ...
  add_svelte_meta(
    () => component(node, Stories, ($$anchor2, Stories_1) => {
      Stories_1($$anchor2, {});
    }),
    "component",
    StoriesExtractor,
...
create_custom_element(StoriesExtractor, { Stories: {}, repository: {} }, [], [], true);
...
function capitalize2(str2) {
  return capitalize(toString(str2));
}
...
function camelCase2(str2) {
  return camelCase(normalizeForCase(deburr2(str2)));
}

// node_modules/es-toolkit/dist/compat/string/endsWith.mjs
function endsWith(str2, target, position) {
  if (str2 == null || target == null) {
    return false;
  }
  if (position == null) {
    position = str2.length;
  }
  return str2.endsWith(target, position);
}
...
function escapeRegExp2(str2) {
  return escapeRegExp(toString(str2));
}
...
function kebabCase2(str2) {
  return kebabCase(normalizeForCase(deburr2(str2)));
}
...
function lowerCase2(str2) {
  return lowerCase(normalizeForCase(deburr2(str2)));
}
...
function lowerFirst2(str2) {
  return lowerFirst(toString(str2));
}

// node_modules/es-toolkit/dist/string/pad.mjs
function pad(str2, length, chars = " ") {
...
function pad2(str2, length, chars) {
  return pad(toString(str2), length, chars);
}

// node_modules/es-toolkit/dist/compat/string/padEnd.mjs
function padEnd(str2, length = 0, chars = " ") {
  return toString(str2).padEnd(length, chars);
}

// node_modules/es-toolkit/dist/compat/string/padStart.mjs
function padStart(str2, length = 0, chars = " ") {
  return toString(str2).padStart(length, chars);
}
...
function repeat(str2, n, guard) {
  if (guard ? isIterateeCall(str2, n, guard) : n === void 0) {
    n = 1;
  } else {
    n = toInteger(n);
  }
...
function snakeCase2(str2) {
  return snakeCase(normalizeForCase(deburr2(str2)));
}
...
function startCase(str2) {
  const words$1 = words(normalizeForCase(deburr2(str2)).trim());
  let result2 = "";
...
function startsWith(str2, target, position) {
  if (str2 == null || target == null) {
    return false;
  }
  if (position == null) {
  ...
  return str2.startsWith(target, position);
}
...
function trimEnd(str2, chars) {
  ...
  switch (typeof chars) {
    case "string": {
      ...
      while (endIndex > 0 && str2[endIndex - 1] === chars) {
        endIndex--;
      }
      break;
    }
    case "object": {
      while (endIndex > 0 && chars.includes(str2[endIndex - 1])) {
        endIndex--;
      }
    }
  }
...
function trimStart(str2, chars) {
  ...
  switch (typeof chars) {
    case "string": {
      while (startIndex < str2.length && str2[startIndex] === chars) {
        startIndex++;
      }
      break;
    }
    case "object": {
      while (startIndex < str2.length && chars.includes(str2[startIndex])) {
        startIndex++;
      }
    }
  }
...
function trim(str2, chars) {
  ...
  return trimStart(trimEnd(str2, chars), chars);
}

// node_modules/es-toolkit/dist/compat/string/trim.mjs
function trim2(str2, chars, guard) {
  if (str2 == null) {
    return "";
  }
  ...
  switch (typeof chars) {
    case "object": {
      if (Array.isArray(chars)) {
        return trim(str2, chars.flatMap((x) => x.toString().split("")));
      } else {
        return trim(str2, chars.toString().split(""));
      }
    }
    default: {
      return trim(str2, chars.toString().split(""));
...
function trimEnd2(str2, chars, guard) {
  if (str2 == null) {
    return "";
  }
  if (guard != null || chars == null) {
  ...
  return trimEnd(str2, chars.toString().split(""));
}

// node_modules/es-toolkit/dist/compat/string/trimStart.mjs
function trimStart2(str2, chars, guard) {
  if (str2 == null) {
    return "";
  }
  if (guard != null || chars == null) {
    return str2.toString().trimStart();
  }
  return trimStart(str2, chars.toString().split(""));
}
...
function upperCase2(str2) {
  return upperCase(normalizeForCase(deburr2(str2)));
}
...
function upperFirst2(str2) {
  return upperFirst(toString(str2));
}
...
function words2(str2, pattern = rUnicodeWord, guard) {
  const input = toString(str2);
  if (guard) {
...
function StoryRenderer($$anchor, $$props) {
  ...
  let Stories = prop($$props, "Stories", 7), exportName = prop($$props, "exportName", 7), args = prop($$props, "args", 7), storyContext = prop($$props, "storyContext", 7), metaRenderSnippet = prop($$props, "metaRenderSnippet", 7);
  ...
  user_effect(() => {
    context.set({
      ...
      metaRenderSnippet: metaRenderSnippet()
    });
  });
  user_effect(() => {
    emitCode({ args: args(), storyContext: storyContext() });
  });
  var $$exports = {
    get Stories() {
      return Stories();
    ...
    set metaRenderSnippet($$value) {
      metaRenderSnippet($$value);
      flushSync();
    },
    ...legacy_api()
  };
